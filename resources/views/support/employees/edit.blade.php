<x-layout.app title="Edit Karyawan" pageTitle="Edit Karyawan">
    ...
    <div style="max-width: 640px;">
        <div class="card">
            <div class="card-header">
                <span class="card-title">Edit Data Karyawan</span>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('support.employees.update', $user) }}">
                    @csrf
                    @method('PATCH')
