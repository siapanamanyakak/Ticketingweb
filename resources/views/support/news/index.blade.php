<x-layout.app title="News Management" pageTitle="News Management">
                ...
                <tbody>
                    @forelse($news as $item)
                        <tr>
                            ...
                            <td style="font-size:12px; color:var(--gray-500);">
                                {{ $item->ends_at?->format('d M Y, H:i') ?? 'Tidak ada' }}
                            </td>
                            <td>
                            ...
                            <td>
                                <div style="display:flex; gap:6px;">
                                    ...
                                    <form method="POST" action="{{ route('support.news.toggle', $item) }}"
                                    ...
                                    <form id="delete-form-{{ $item->id }}" method="POST" action="{{ route('support.news.destroy', $item) }}">
                                        @csrf @method('DELETE')
    ...
    <script>
        ...
        function openEditNewsModal(id, title, desc, type, startsAt, endsAt) {
            ...
            document.getElementById('editNewsForm').action = `/support/news/${id}`;
