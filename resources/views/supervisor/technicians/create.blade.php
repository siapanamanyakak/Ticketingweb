<x-layout.app title="Tambah Teknisi" pageTitle="Tambah Teknisi">
    ...
    <div class="page-header">
        <div style="display:flex; align-items:center; gap:12px;">
            ...
            <div>
                <h1 class="page-title">Tambah Teknisi</h1>
                <p class="page-subtitle">Buat akun IT Support baru</p>
            </div>
        </div>
    </div>
    ...
    <div style="max-width: 640px;">
        <div class="card">
            <div class="card-header">
                <span class="card-title">Form Teknisi Baru</span>
            </div>
            <div class="card-body">
